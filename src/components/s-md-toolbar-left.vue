<template>
    <div class="left">
        ...
        <button :disabled="!editable" type="button" v-if="toolbars.aligncenter" @click="$clicks('aligncenter')"
                ...
                aria-hidden="true" :title="`${d_words.tl_aligncenter} (ctrl+e)`">
        </button>
        ...
        <button :disabled="!editable" type="button" v-if="toolbars.link" @click="$clicks('link')"
                class="op-icon fa fa-mavon-link" aria-hidden="true"
                :title="`${d_words.tl_link} (ctrl+l)`"></button>
        <button :disabled="!editable" type="button" v-if="toolbars.imagelink" ref="img" @click="$clicks('imagelink')"
